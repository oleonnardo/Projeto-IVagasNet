...
public class tabelaCidade extends javax.swing.JInternalFrame {

    Connection conexao;
    PreparedStatement pst;
    ResultSet rs;

    public tabelaCidade() throws ClassNotFoundException {
        initComponents();
    ...
    public void pesquisar() {
        ...
        String sql = "Select *from cidade where nome like ? order by codigo Asc";
        ...
        try {
            ...
            pst.setString(1, buscarTF.getText() + "%");
            rs = pst.executeQuery();
            TabelaCidade.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    public void mostraInformacoes() {
        ...
        int seleciona = TabelaCidade.getSelectedRow();

        codigoTF.setText(TabelaCidade.getModel().getValueAt(seleciona, 0).toString());
        buscarTF.setText(TabelaCidade.getModel().getValueAt(seleciona, 1).toString());
    }

    public void listar() {

        String sql = "Select *from cidade order by codigo Asc";
    ...
    private void initComponents() {
        ...
        TabelaCidade.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        jlLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/projeto/interfaces/imagens/img/cidade.png"))); // NOI18N
